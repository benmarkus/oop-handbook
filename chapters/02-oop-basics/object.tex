...
A fenti kódrészletben a \code{new} kulcsszót használva hozzuk létre az objektumot, az \code{Object()} adja meg hogy milyen objektumot hozunk létre (jelen esetben ez az \code{Object} osztály), az \code{obj1} pedig a fent említett változó.
